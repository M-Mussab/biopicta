...
const Control = () => {
  return (
    <>
      <section className="bg-[#2A5650] pt-14 pb-14">
        <div className="flex">
          <h1 className="text-green-600 text-3xl font-semibold items-center pt-10 pl-5">
            AI-powered Whizz<sup className="text-green-600 font-bold">TM</sup>
          </h1>
        </div>
        <div>
          <h1 className="text-white text-3xl font-semibold items-center pb-8 pl-5">
        ...
        <div className="pl-5 pb-8">
          {testimonials.map((item, index) => (
            <div key={index} className="flex items-center gap-2">
              ...
              <h1 className="text-white text-1xl">{item}</h1>
            </div>
          ))}
        </div>
      </section>
