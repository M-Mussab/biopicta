...
export const members = [
  {
    quote: {
      line1: "Create unique scientific posters without the hassle of manual adjustments.",
      line2: "Focus more on your research and less on tweaking poster design.",
      line3: "User-friendly poster templates designed specifically for scientists.",
  ...
  {
    quote: {
      line1: "Download high-end JPG, PNG, and PDF files for e-presentations and printing.",
      line2: "Auto-resizing with ratio and proportion ensures consistent margins.",
      line3: "Select templates in portrait, landscape, or square formats effortlessly."
    },
    package: "Try It For FREE!",
    title: "Ready Made Poster Templates In Portrait, Landscape, And Square Sizes",
    image: Images2
  },
  {
    quote: {
      line1: "Collaborate with co-authors in real-time, sharing and editing posters without barriers.",
        ...
        {members.map((member, index) => (
          ...
          >
            ...
            <div className="text-left lg:mx-6">
              <h2 className="text-xl font-bold text-gray-800 mb-2">{member.title}</h2>
